#!/bin/bash
BLOCK2_LIBS=/home/loharkar/Python-pacakage/quenais/quenais-env/lib/python3.11/site-packages/block2.libs
...
exec /home/loharkar/Python-pacakage/quenais/quenais-env/lib/bin/block2main "$@"