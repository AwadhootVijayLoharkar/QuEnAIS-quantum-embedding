# classical_methods.py — test7 — Classical Reference Methods
"""
Runs classical quantum chemistry methods on the full molecule for
comparison against the DMET+GQE result. Same method set as test5's
step0_classical.py, adapted to test7's config.py (explicit finite
geometries -- see the note in config.py about why mineral CIFs aren't
supported here).
...
with the DMET/GQE pipeline; otherwise this falls back to a generic guess.
